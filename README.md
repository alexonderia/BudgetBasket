...
BudgetBasket — система сбора, согласования и утверждения бюджетных заявок по модулям компании. Сотрудник создаёт заявку и её строки, экономист проверяет и замораживает результат, согласующие проводят заявку по единому графу, а ЗГД окончательно фиксирует бюджет. Администратор управляет пользователями, оргструктурой, справочниками и маршрутом.
...
Единый процесс согласования называется «Согласование бюджета организаций на 2027 год». При первой отправке заявки система автоматически создаёт листовой шаг соответствующего модуля и назначает на него закреплённого экономиста. Администратор строит визуальный граф из таких модулей, проверяющих и ЗГД. Экономист завершает проверку заявок своего листового шага и передаёт их дальше. После проверки заявка заморожена. При возврате каждый согласующий выбирает непосредственную дочернюю ветку и пишет комментарий ко всей заявке; на листовом шаге экономист явно размораживает её для правки сотрудником. Финальное действие ЗГД закрывает весь граф и устанавливает заявкам необратимый признак `fixed`.
