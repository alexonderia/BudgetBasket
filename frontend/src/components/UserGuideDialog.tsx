...
const commonSections: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'Для общей выгрузки в разделе «Заявки» нажмите «Настроить экспорт»: выберите статусы и состав выгрузки — доходы, расходы или оба вида. При необходимости включите «Экспортировать только зафиксированные заявки» и отметьте чекбоксами нужные подразделения или модули. Модули раскрываются стрелкой рядом с подразделением. Без выбора экспортируются все доступные подразделения. Без вложений скачивается XLSX, с вложениями — ZIP с XLSX и файлами.',
  ...
  employee: [
    {
      ...
      items: [
        ...
        'Откройте созданную заявку. В разделах «Резервирование бюджета» и «Доходы модуля» выберите статью или проект из справочника, укажите «Плановую сумму» и нажмите «Добавить строку». Добавляйте только необходимые строки.',
  ...
  admin: [
    ...
    },
    {
      ...
      items: [
        ...
        'Годовой бюджет не задаётся вручную: он формируется из сумм одобренных строк закрытых заявок. На карточке подразделения учитываются также его модули.',
    ...
    },
    {
      ...
      items: [
        ...
        'Для сводной выгрузки нажмите «Настроить экспорт», выберите статусы и состав: доходы, расходы или оба вида, затем отметьте чекбоксами подразделения или отдельные модули. При необходимости ограничьте выгрузку только зафиксированными заявками. При включении вложений система сформирует ZIP-архив; без них — XLSX.',
